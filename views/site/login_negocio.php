...
<body>
    ...
    <h1 class="titulo">Registro de Negocios</h1>
    ...
    <div class="padre">
        ...
        <div class="divs" id="izquierda">
            <br>
                ...
                <br>
                <br>
            <form method="post" action="<?php echo Yii::$app->getUrlManager()->getBaseUrl(); ?>/index.php?r=site%2Fregistronegocio" onSubmit="return valid1()">
                <div class="inputs">
